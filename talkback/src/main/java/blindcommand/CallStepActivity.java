...
public class CallStepActivity extends Activity {
    private static String TAG = CallStepActivity.class.getSimpleName();
    // 语音识别对象
...
//
//        // 获取联系人，本地更新词典时使用
//        ContactManager mgr = ContactManager.createManager(CallStepActivity.this, mContactListener);
//        mLocalGrammar = Fun
