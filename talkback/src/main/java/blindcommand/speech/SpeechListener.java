...
//    private SharedPreferences mSharedPreferences;
    ...
    public SpeechListener(Context context, SpeechCallback speechCallback){
...
//    }
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        private StringBuffer recognizeResult = new StringBuffer();
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            if( mTranslateEnable ){
                ...
                recognizeResult.append(text);
            }

            if(isLast) {
                mSpeechCallback.onStringResult(recognizeResult.toString());
...
//        mIat.setParameter(SpeechConstant.VAD_EOS, mSharedPreferences.getString("iat_vadeos_preference", "1000"));
        mIat.setParameter(SpeechConstant.VAD_BOS, "800");
